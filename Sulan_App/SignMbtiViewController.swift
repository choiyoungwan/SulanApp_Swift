...
// 뷰컨트롤러에서 콜렉션 뷰 사용
class SignMbtiViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout{
...
//    }
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        if let cell = collectionView.cellForItem(at: indexPath) as? CSCollectionViewCell {
            ...
            print(" \(list[indexPath.row]) 확인")
            mbtiT = list[indexPath.row]
        }
    }
    ...
    override func viewDidLoad() {
        ...
        print("===넘어온값=== \n 닉네임 확인 \(nickT),성별확인\(sexT),나이확인\(ageT),연생확인\(yearT),mbti확인\(mbtiT) ")
